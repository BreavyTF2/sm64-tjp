...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_DL( MODEL_BLOOD_PARTICLE,          white_particle_small_unused_dl,     LAYER_ALPHA),
	...
	LOAD_MODEL_FROM_GEO(MODEL_STAR_DUST_SCRAPPED,      star_dust_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_ZZZ,             sleep_particle_geo),
	LOAD_MODEL_FROM_GEO(MODEL_ZZZ2,            sleep_particle_geo2),
	LOAD_MODEL_FROM_GEO(MODEL_ZZZ3,            sleep_particle_geo3),
    FREE_LEVEL_POOL(),
...
const LevelScript script_func_global_1[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_UNKNOWN_B8,     RCP_HmsEnemyhopper),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BOBOMB_BUDDY,            black_bobomb_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_UNKNOWN_58,			   RCP_HmsEnemymotos_basedata_A),
    RETURN(),
};
...
const LevelScript script_func_global_4[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_WATER_MINE,              ground_mine_geo),
	LOAD_MODEL_FROM_GEO(MODEL_WIGGLER_OLD,             RCP_HmsEnemyhana),
    RETURN(),
};
