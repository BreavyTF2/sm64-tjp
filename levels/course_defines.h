...
DEFINE_COURSE(COURSE_BOB,  0x00202240)            // (1)  Bob Omb Battlefield
DEFINE_COURSE(COURSE_WF,   0x00220040)            // (2)  Whomp's Fortress
...
DEFINE_COURSES_END()
DEFINE_BONUS_COURSE(COURSE_BITDW,    0x34444440) // (15) Bowser in the Dark World
DEFINE_BONUS_COURSE(COURSE_BITFS,    0x34444440) // (16) Bowser in the Fire Sea
DEFINE_BONUS_COURSE(COURSE_BITS,     0x34444440) // (17) Bowser in the Sky
DEFINE_BONUS_COURSE(COURSE_PSS,      0x24444440) // (18) Princess's Secret Slide
DEFINE_BONUS_COURSE(COURSE_COTMC,    0x44444440) // (19) Cavern of the Metal Cap
DEFINE_BONUS_COURSE(COURSE_TOTWC,    0x04444440) // (20) Tower of the Wing Cap
DEFINE_BONUS_COURSE(COURSE_VCUTM,    0x24444440) // (21) Vanish Cap Under the Moat
DEFINE_BONUS_COURSE(COURSE_WMOTR,    0x04444440) // (22) Winged Mario over the Rainbow
DEFINE_BONUS_COURSE(COURSE_SA,       0x24444440) // (23) Secret Aquarium
DEFINE_BONUS_COURSE(COURSE_CASTLE,   0x24444440) // (24) Hidden Castle
DEFINE_BONUS_COURSE(COURSE_DONJON,   0x24444440) // (25) Forgotten Walls
DEFINE_BONUS_COURSE(COURSE_ENDING,   0x24444440) // (26) Delicious Cake
