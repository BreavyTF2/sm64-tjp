...
const Collision inside_castle_seg7_area_2_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(4),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_3star_door, /*pos*/ -2695, 1203,  1828, /*yaw*/  64),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_3star_door, /*pos*/  6994, 1203,  1828, /*yaw*/  64),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_3star_door, /*pos*/  1670, 1203,  1828, /*yaw*/ 192),
