...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_JRB_SLIDING_BOX,          /*pos*/  4668,  944,  2916, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvJrbFloatingBox,           /*acts*/ ACT_1),
    OBJECT_WITH_ACTS(/*model*/ MODEL_JRB_SHIP_BACK_LEFT_PART,                     /*pos*/  5385, -5520,  2428, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvInSunkenShip,            /*acts*/ ACT_1),
    OBJECT_WITH_ACTS(/*model*/ MODEL_JRB_SHIP_BACK_RIGHT_PART,                     /*pos*/  5385, -5520,  2428, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvInSunkenShip2,          /*acts*/ ACT_1),
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_JRB_SHIP_BACK_RIGHT_PART, /*pos*/  4880,   820,  2375, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvInSunkenShip3,               /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
	...
	OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,                     /*pos*/  4988, -5221, 2473,  /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFishGroup,                /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
...
const LevelScript level_jrb_entry[] = {
    ...
    AREA(/*index*/ 1, jrb_geo_000A18),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -6750, 2126, 1482, /*angle*/ 0, 64, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSpinAirborneWarp),
    ...
    AREA(/*index*/ 2, jrb_geo_000AFC),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 866, 798, -1248, /*angle*/ 0, 128, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSwimmingWarp),
    ...
    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, /*yaw*/ 64, /*pos*/ -6750, 1126, 1482),
