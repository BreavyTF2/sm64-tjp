...
DEFINE_LEVEL("FIRE BUBBLE2",   LEVEL_RR,               COURSE_NONE,     firebubble2,      generic,  20000,    0x20, 0x20, 0x20, _,         sCamRR)
...
DEFINE_LEVEL("EXT10 CAKE",     LEVEL_ENDING,           COURSE_ENDING,   ending,           generic,  20000,    0x00, 0x00, 0x00, _,         _)
...
DEFINE_LEVEL("EXT5 IN FALL",   LEVEL_COTMC,            COURSE_COTMC,    cotmc,            cave,     18000,    0x28, 0x28, 0x28, _,         sCamCotMC)
...
DEFINE_LEVEL("CAVE DUNGEON",   LEVEL_UNKNOWN_38,       COURSE_NONE,     sand,             generic,  20000,    0x08, 0x08, 0x08, sDynUnk38, _)
