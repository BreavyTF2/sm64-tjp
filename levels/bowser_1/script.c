...
const LevelScript level_bowser_1_entry[] = {
    ...
    LOAD_MIO0(/*seg*/ 0x0A, _clouds_skybox_mio0SegmentRomStart, _bidw_skybox_mio0SegmentRomEnd),
    ...
    AREA(/*index*/ 1, bowser_1_geo_0000D0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 1307, 0, /*angle*/ 0, 1423, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSpinAirborneCircleWarp),
    ...
    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, /*yaw*/ 1423, /*pos*/ 0, 307, 0),
