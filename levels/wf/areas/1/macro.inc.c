...
const MacroObject wf_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT(/*preset*/ macro_box_one_coin,               /*yaw*/   0, /*pos*/  1270,  4100, 930),
    ...
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4736,  256,  4992),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4608,  256,  5120),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4608,  256,  4992),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4608,  256,  4864),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4480,  256,  4992),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4608,  256,   256),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4736,  256,   128),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4480,  256,   128),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4608,  256,     0),
    MACRO_OBJECT(/*preset*/ macro_butterfly,                    /*yaw*/   0, /*pos*/  4608,  256,   128),
    MACRO_OBJECT_END(),
};
