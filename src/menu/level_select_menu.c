...
extern char _mainSegmentNoloadEnd[];
extern char _engineSegmentNoloadEnd[];
extern char _mainSegmentNoloadStart[];
extern char _engineSegmentNoloadStart[];
...
s16 level_select_input_loop(void) {
    ...
    gCurrActNum = 6;
	print_text_fmt_int(200, 116, "CODE %dK", ((int)_mainSegmentNoloadStart - (int)_mainSegmentNoloadStart) / 1024 - 5);
	print_text_fmt_int(200, 100, "ULIB %dK", ((int)_engineSegmentNoloadStart - (int)_engineSegmentNoloadStart) / 1024	);
