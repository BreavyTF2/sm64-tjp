...
COURSE_ACTS(COURSE_WF, _(" 2 WHOMP'S FORTRESS"),
       _("TO THE TOP OF THE FORTRESS")        , _("SHOOT INTO THE WILD BLUE")    , _("INSIDE THE TOWER WALL"),
       _("FALL ONTO THE HOVERING STAR"), _("ON TOP OF THE TOWER")    , _("RED COINS ON THE FLOATING ISLE"))
