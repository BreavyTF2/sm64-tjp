...
const BehaviorScript bhvBlargg[] = {
	...
	LOAD_ANIMATIONS(oAnimations, blargg_seg5_anims_0500616C),
	    SET_HITBOX(/*Radius*/ 295, /*Height*/ 195),
		SET_HURTBOX(/*Radius*/ 300, /*Height*/ 200),
		SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 60, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ -200, /*Unused*/ 0, 0),
		DROP_TO_FLOOR(),
	SET_HOME(),
	    SET_INT(oDamageOrCoinValue, 3),
