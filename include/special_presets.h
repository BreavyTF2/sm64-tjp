...
static struct SpecialPreset SpecialObjectPresets[] =
{
    ...
    {0x8A, SPTYPE_DEF_PARAM_AND_YROT, 0x01, MODEL_CASTLE_DOOR_0_STARS, bhvDoor},
    {0x8B, SPTYPE_DEF_PARAM_AND_YROT, 0x02, MODEL_CASTLE_DOOR_1_STAR, bhvDoor},
    {0x8C, SPTYPE_DEF_PARAM_AND_YROT, 0x05, MODEL_CASTLE_DOOR_3_STARS, bhvDoor},
