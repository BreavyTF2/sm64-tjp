...
extern const BehaviorScript bhvStub1D0E[];
...
extern const BehaviorScript bhvYajimaCube[];
extern const BehaviorScript bhvYajimaCube2[];
extern const BehaviorScript bhvYajimaCube3[];
...
extern const BehaviorScript bhvTestElevetor[];
...
extern const BehaviorScript bhvTree2[];
...
extern const BehaviorScript bhvWaterSplashRed[];
extern const BehaviorScript bhvWaterSplash[];
extern const BehaviorScript bhvWaterDroplet[];
extern const BehaviorScript bhvWaterDropletFish[];
...
extern const BehaviorScript bhvSandPitSoundLoop[];
