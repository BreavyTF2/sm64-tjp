...
#define ACT_CHARGE                     0x00800458 // (0x058 | ACT_FLAG_MOVING | ACT_FLAG_ATTACKING)
...
#define ACT_SPECIAL_TRIPLE_JUMP        0x108008AF // (0x0AF | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_METAL_WATER_STANDING       0x180042F0 // (0x0F0 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_METAL_WATER_FALLING        0x100044F4 // (0x0F4 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_SWIMMING_OR_FLYING)
#define ACT_HOLD_METAL_WATER_FALLING   0x000044F5 // (0x0F5 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER)
#define ACT_METAL_WATER_FALL_LAND      0x100044F6 // (0x0F6 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_SWIMMING_OR_FLYING)
#define ACT_HOLD_METAL_WATER_FALL_LAND 0x000044F7 // (0x0F7 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER)
#define ACT_METAL_WATER_JUMP           0x128044F8 // (0x0F8 | ACT_FLAG_MOVING | ACT_FLAG_METAL_WATER | ACT_FLAG_CONTROL_JUMP_HEIGHT | ACT_FLAG_SWIMMING_OR_FLYING)
#define ACT_HOLD_METAL_WATER_JUMP      0x028044F9 // (0x0F9 | ACT_FLAG_MOVING | ACT_FLAG_METAL_WATER | ACT_FLAG_CONTROL_JUMP_HEIGHT)
#define ACT_METAL_WATER_JUMP_LAND      0x100044FA // (0x0FA | ACT_FLAG_MOVING | ACT_FLAG_METAL_WATER | ACT_FLAG_SWIMMING_OR_FLYING)
