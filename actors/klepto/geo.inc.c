      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 GEO_ASM(0, geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, 100, 0, 180, 270, 0, gfx_polystar),
                                 GEO_ASM(0, geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, 0, 100, 0, 180, 270, 0, gfx_polystar_eye),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                           GEO_NODE_START(),
                           GEO_OPEN_NODE(),
            ...
            GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, klepto_seg5_dl_05004118),
			 GEO_BILLBOARD(),
                  GEO_OPEN_NODE(),
                     GEO_DISPLAY_LIST(LAYER_ALPHA, angry_sun_seg8_dl_1),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
