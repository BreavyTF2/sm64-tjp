...
#include "actors/mario_cap/mario_cap_metal.ia16.inc.c"
};
...
#include "actors/mario_cap/mario_cap_metal_wing_unused.ia16.inc.c"
};

// 0x03021750
ALIGNED8 static const u8 mario_cap_seg3_texture_03021750[] = {
#include "actors/mario_cap/mario_cap_metal_wing_tip_unused.ia16.inc.c"
};
...
const Gfx mario_cap_seg3_dl_03022FF8[] = {
    ...
    gsDPLoadTextureBlock(mario_cap_seg3_texture_0301CF50, G_IM_FMT_IA, G_IM_SIZ_16b, 64, 32, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_WRAP | G_TX_NOMIRROR, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
...
const Gfx mario_cap_seg3_dl_03023108[] = {
    ...
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(mario_cap_seg3_dl_03022E78),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, mario_cap_seg3_texture_03021750),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(mario_cap_seg3_dl_03022EA8),
    gsSPDisplayList(mario_cap_seg3_dl_03022F20),
...
const Gfx mario_cap_seg3_dl_03023298[] = {
    ...
    gsSPSetGeometryMode(G_TEXTURE_GEN),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, mario_cap_seg3_texture_0301CF50),
