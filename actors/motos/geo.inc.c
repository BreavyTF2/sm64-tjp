   ...
   GEO_SCALE(0x00, 16384),
    GEO_OPEN_NODE(),
	  ...
	  GEO_OPEN_NODE(),
		GEO_BILLBOARD(),
	    GEO_OPEN_NODE(),
		  GEO_DISPLAY_LIST(LAYER_ALPHA,RCP_motos_body),
	  	GEO_CLOSE_NODE(),
	  GEO_CLOSE_NODE(),
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                    GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_LhandB), /* cube5(1),*/
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_LhandA), /* cube6(2),*/
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               ...
               GEO_OPEN_NODE(),
				  ...
				  GEO_OPEN_NODE(),
				  		GEO_BILLBOARD(),
						GEO_OPEN_NODE(),
						  GEO_DISPLAY_LIST(LAYER_ALPHA, RCP_motos_arm),
						GEO_CLOSE_NODE(),
				  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_RhandA), /* cube3(4),*/
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_RhandB), /* cube4(5),*/
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_Lfoot), /* cube2(6),*/
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0, NULL), /* L_foot_sprite(7),*/
				  GEO_OPEN_NODE(),
				    GEO_BILLBOARD(),
				    GEO_OPEN_NODE(),
					  GEO_DISPLAY_LIST(LAYER_ALPHA, RCP_motos_leg),
				    GEO_CLOSE_NODE(),
				  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_Rfoot), /* cube7(8),*/
                  GEO_CLOSE_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_OPAQUE,0,0,0,RCP_motos_head), /* sphere3(10),*/
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
