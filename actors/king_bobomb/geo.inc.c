         ...
         hmsBegin()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_bom_king_carry0,0,0,0)  /* ,king_Lfoot,(0) */
                     hmsEnd()
                     hmsJoint(RM_SURF,RCP_bom_king_carry1,0,0,0)  /* ,king_Lleg,(1) */
                  hmsEnd()
               hmsEnd()
            hmsEnd()
            hmsJoint(RM_SPRITE,RCP_bom_king_carry10,0,0,0)  /* ,king_eye,(25) */
            hmsJoint(RM_SURF,RCP_bom_king_carry9,0,0,0)  /* ,king_hige,(24) */
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_bom_king_carry2,0,0,0)  /* ,king_Rfoot,(2) */
                     hmsEnd()
                     hmsJoint(RM_SURF,RCP_bom_king_carry3,0,0,0)  /* ,king_Rleg,(3) */
                  hmsEnd()
               hmsEnd()
            hmsEnd()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_bom_king_carry4,0,0,0)  /* ,king_Lhand,(4) */
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     hmsJoint(RM_SURF,RCP_bom_king_carry7,0,0,0)  /* ,king_Rarm,(11) */
