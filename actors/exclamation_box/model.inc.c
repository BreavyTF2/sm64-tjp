...
// 0x08017628
ALIGNED8 static const u8 exclamation_box_seg8_texture_08018628[] = {
#include "actors/exclamation_box/metal_wing_cap_box_front.rgba16.inc.c"
};

// 0x08017E28
ALIGNED8 static const u8 exclamation_box_seg8_texture_08018E28[] = {
...
// 0x08019438 - 0x08019498
const Gfx exclamation_box_seg8_dl_08019498[] = {
    gsSPDisplayList(exclamation_box_seg8_dl_08019058),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, exclamation_box_seg8_texture_08018628),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(exclamation_box_seg8_dl_08018FA8),
    gsDPTileSync(),
