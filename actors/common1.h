...
extern const Gfx RCP_FireC_2_Yellow01[];
extern const Gfx RCP_FireC_2_Yellow02[];
extern const Gfx RCP_FireC_2_Yellow03[];
extern const Gfx RCP_FireC_2_Yellow04[];
extern const Gfx RCP_FireC_2_Yellow05[];
extern const Gfx RCP_FireC_2_Yellow06[];
extern const Gfx RCP_FireC_2_Yellow07[];
extern const Gfx RCP_FireC_2_Yellow08[];
extern const Gfx RCP_FireC_2_Yellow09[];
extern const Gfx RCP_FireC_2_Yellow10[];
extern const Gfx RCP_FireC_2_Yellow11[];
extern const Gfx RCP_FireC_2_Yellow12[];
extern const Gfx RCP_FireC_2_Yellow13[];
extern const Gfx RCP_FireC_2_Yellow14[];
extern const Gfx RCP_FireC_2_Yellow15[];
extern const Gfx RCP_FireC_Blue01[];
extern const Gfx RCP_FireC_Blue02[];
extern const Gfx RCP_FireC_Blue03[];
extern const Gfx RCP_FireC_Blue04[];
extern const Gfx RCP_FireC_Blue05[];
extern const Gfx RCP_FireC_Blue06[];
extern const Gfx RCP_FireC_Blue07[];
extern const Gfx RCP_FireC_Blue08[];
extern const Gfx RCP_FireC_Blue09[];
extern const Gfx RCP_FireC_Blue10[];
extern const Gfx RCP_FireC_Blue11[];
extern const Gfx RCP_FireC_Blue12[];
extern const Gfx RCP_FireC_Blue13[];
extern const Gfx RCP_FireC_Blue14[];
extern const Gfx RCP_FireC_Blue15[];
extern const Gfx gfx_fireC_yellow[];
extern const Gfx gfx_fireC_2_yellow[];
extern const Gfx gfx_fireC_blue[];
...
extern const GeoLayout sleep_particle_geo2[];
extern const GeoLayout sleep_particle_geo3[];
extern const Gfx sleep_particle_dl[];
extern const Gfx sleep_particle_dl2[];
extern const Gfx sleep_particle_dl3[];
