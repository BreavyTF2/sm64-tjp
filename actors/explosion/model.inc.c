...
static const Vtx explosion_seg3_vertex_030009C8[] = {
    {{{  -128,   -128,      0}, 0, {     0,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,   -128,      0}, 0, {   992,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,    128,      0}, 0, {   992,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,    128,      0}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
};
...
const Gfx explosion_seg3_dl_03004208[] = {
	...
	gsDPSetEnvColor(255, 255, 255, 220),
