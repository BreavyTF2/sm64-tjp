...
static Vtx vtx_damegemeter[] = {
	{ -32*0.75 , -32*0.75 ,  0,  0 ,        0 ,              0,   255,255,255,220}, 
	{   0 , -32*0.75 ,  0,  0 , (31 << 5),              0,   255,255,255,220}, 
	{   0 ,  32*0.75 ,  0,  0 , (31 << 5),    ( -63 << 5),   255,255,255,220}, 
	{ -32*0.75 ,  32*0.75 ,  0,  0 ,         0,    ( -63 << 5),   255,255,255,220}, 

	{   0 , -32*0.75 ,  0,  0 ,        1 ,              0,   255,255,255,220}, 
	{  32*0.75 , -32*0.75 ,  0,  0 , (31 << 5),              0,   255,255,255,220}, 
	{  32*0.75 ,  32*0.75 ,  0,  0 , (31 << 5),    ( -63 << 5),   255,255,255,220}, 
	{   0 ,  32*0.75 ,  0,  0 ,        1 ,    ( -63 << 5),   255,255,255,220}, 
};
