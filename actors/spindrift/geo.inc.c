         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, RCP_furafura_anim_waitfly6),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, RCP_furafura_anim_waitfly5),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, RCP_furafura_anim_waitfly4),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, RCP_furafura_anim_waitfly2),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, RCP_furafura_anim_waitfly0),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
            GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, NULL),
            GEO_OPEN_NODE(),
