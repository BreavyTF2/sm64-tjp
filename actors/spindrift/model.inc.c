...
static const Vtx spindrift_seg5_vertex_050000C0[] = {
    {{{    34,     40,     30}, 0, {     0,      0}, {0x7b, 0x17, 0x11, 0xff}}},
    {{{    34,    -16,     46}, 0, {     0,      0}, {0x7b, 0xf7, 0x1c, 0xff}}},
    {{{    46,      0,      0}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
...
static const Vtx spindrift_seg5_vertex_05000120[] = {
    {{{     6,      0,      0}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{    34,    -16,    -46}, 0, {     0,      0}, {0x92, 0xee, 0xc4, 0xff}}},
    {{{    34,    -50,      0}, 0, {     0,      0}, {0x92, 0xc2, 0x00, 0xff}}},
...
static Vtx vtx_furafura_anim_waitfly0[]={
	{28,-6,21,0,0,0,126,-3,11,255},
	{42,-23,-134,0,0,0,126,-3,11,255},
	{42,100,-96,0,0,0,126,-3,11,255},
};
static Vtx vtx_furafura_anim_waitfly2[]={
	{28,18,12,0,0,0,126,10,6,255},
	{42,-135,-16,0,0,0,126,10,6,255},
	{42,-63,-124,0,0,0,126,10,6,255},
};
static Vtx vtx_furafura_anim_waitfly4[]={
	{28,17,-13,0,0,0,126,9,-7,255},
	{42,-55,124,0,0,0,126,9,-7,255},
	{42,-137,23,0,0,0,126,9,-7,255},
};
static Vtx vtx_furafura_anim_waitfly5[]={
	{28,-10,-20,0,0,0,126,-4,-11,255},
	{42,101,89,0,0,0,126,-4,-11,255},
	{42,-19,138,0,0,0,126,-4,-11,255},
};
static Vtx vtx_furafura_anim_waitfly6[]={
	{28,-22,0,0,0,0,126,-12,0,255},
	{42,122,-62,0,0,0,126,-12,0,255},
	{42,122,68,0,0,0,126,-12,0,255},
};
