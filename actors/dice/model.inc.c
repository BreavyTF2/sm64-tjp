...
static const Vtx dice_seg8_vertex_08018E28[] = {
    {{{   -25,      -25,    -25}, 0, {   991,    991}, {0x00, 0x00, 0x81, 0xff}}},	//0
    {{{   -25,     25,    -25}, 0, {   991,      0}, {0x00, 0x00, 0x81, 0xff}}},	//1
    {{{    25,     25,    -25}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},	//2
    {{{    25,      -25,    -25}, 0, {     0,    991}, {0x00, 0x00, 0x81, 0xff}}},	//3
    {{{   -25,      -25,     25}, 0, {     0,    991}, {0x00, 0x00, 0x7f, 0xff}}},	//4
    {{{    25,      -25,     25}, 0, {   991,    991}, {0x00, 0x00, 0x7f, 0xff}}},	//5
    {{{    25,     25,     25}, 0, {   991,      0}, {0x00, 0x00, 0x7f, 0xff}}},	//6
    {{{   -25,     25,     25}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},	//7
    {{{    25,     25,    -25}, 0, {   991,      0}, {0x7f, 0x00, 0x00, 0xff}}},	//8
    {{{    25,      -25,    -25}, 0, {   991,    991}, {0x7f, 0x00, 0x00, 0xff}}},	//9
	{{{    25,      -25,     25}, 0, {     0,    991}, {0x7f, 0x00, 0x00, 0xff}}},	//10
    {{{    25,     25,     25}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},	//11
    {{{   -25,      -25,    -25}, 0, {     0,    991}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -25,      -25,     25}, 0, {   991,    991}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -25,     25,     25}, 0, {   991,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -25,     25,    -25}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
};

// 0x08018F28
static const Vtx dice_seg8_vertex_08018F28[] = {
    {{{    25,      -25,    -25}, 0, {   991,   991}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    25,      -25,     25}, 0, {   991,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,      -25,     25}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,      -25,    -25}, 0, {     0,   991}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,     25,   -25}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -25,     25,     25}, 0, {     0,   991}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    25,     25,     25}, 0, {   991,   991}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    25,     25,    -25}, 0, {   991,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
