...
static Lights1 mat_mariotitle_cube[]={
	DefMaterial(255,153,24),
};
...
const Gfx RCP_TitleCube[]={
	gsDPPipeSync(),
	gsSPNumLights(NUMLIGHTS_1),
	gsSPLight((&mat_mariotitle_cube[0].l[0]),1),
	gsSPLight((&mat_mariotitle_cube[0].a),2),
...
static Lights1 mat_left1[] = {
	DefMaterial(255,254,3),
};

static Lights1 mat_right2[] = {
	DefMaterial(255,254,3),
};
...
const Gfx RCP_left1_0[] = {
	...
	gsSPLight((&mat_left1[0].l[0]),1),
	gsSPLight((&mat_left1[0].a),2),
